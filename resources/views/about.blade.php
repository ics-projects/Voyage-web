				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 info-left">
							<img class="img-fluid" src="../img/bus.jpg" alt="bus">
						</div>
						<div class="col-lg-6 info-right">
							<h6>About Us</h6>
							<h1>Who We Are?</h1>
							<p>
								A bus booking agency that ensures safety, convinient and ease of booking bus tickets
	        ...
	        <div class="row">
	          <div class="col-lg-3  col-md-6 col-sm-6">
	            <div class="single-footer-widget">
	              <h6>About Agency</h6>
								<p>A bus booking agency that ensures safety, convinient and ease of booking bus tickets
								Travel makes one modest. You see what a tiny place you occupy in the world
							</p>
